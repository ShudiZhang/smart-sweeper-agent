...
from utils.amap_client import get_location_by_ip, get_weather_by_city
...
@tool(description="获取指定城市的天气，通过高德天气API查询实时天气信息")
def get_weather(city: str) -> str:
    """调用高德天气 API 获取指定城市实时天气"""
    return get_weather_by_city(city)


@tool(description="获取用户所在城市的名称，通过IP定位自动识别，以纯字符串形式返回")
